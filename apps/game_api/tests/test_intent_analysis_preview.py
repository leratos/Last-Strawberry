...
class TestIntentAnalysisPreview(unittest.TestCase):
    ...
    def test_resolves_other_role_title_reference_when_multiple_visible_candidates_exist(self):
        intent = analyze_player_input_preview(
            world_id="w1",
            world_character_id="wc1",
            player_input="Ich rede mit dem anderen Beschwoerer.",
            inventory=[],
            known_npc_names=["Kael", "Liora"],
            known_npc_refs=[
                {"ref_id": "npc-kael", "name": "Kael", "role": "beschwoerer"},
    ...
    def test_resolves_other_scene_target_reference_by_descriptor(self):
        intent = analyze_player_input_preview(
            world_id="w1",
            world_character_id="wc1",
            player_input="Ich oeffne die andere Kiste.",
            inventory=[],
            known_scene_point_refs=[
                {"ref_id": "ctr-a", "name": "Ritualkiste", "kind": "container"},
                {"ref_id": "ctr-b", "name": "Vorratskiste", "kind": "container"},
